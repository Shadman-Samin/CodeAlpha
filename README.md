# CodeAlpha ML Internship — All 4 Tasks
Student: Shadman Samin | ID: CA/DF1/298776 | Batch: 20 Sep – 20 Oct 2026

| Task | Folder | Status | Key result |
|---|---|---|---|
...
Run each: `pip install -r requirements.txt; python src/train.py`

Submission: push each to GitHub as CodeAlpha_<ProjectName>, LinkedIn video, form via WhatsApp group before 20 Oct 2026.
